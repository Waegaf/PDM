...
def prepare_data(patch_size, stride, aug_times=1, image_type='BSD'):
    ...
    # files = glob.glob(f'C:/Users/waelg/OneDrive/Bureau/EPFL_5.2/Code/convex_ridge_regularizers/training/data/images/{image_type}/train/*.png')
...
if __name__ == "__main__":
    ...
    if image_type == 'MRI':
        ...
        stride = 10
        aug_times = 1
    prepare_data(patch_size=40, stride=stride, aug_times=aug_times)