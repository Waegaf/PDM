...
from utilsTrainingInfConv import step_InfConv_Denoiser
...
class TrainerInfConv:
    ...
    def step_InfConv_Denoiser(self, model, x_noisy, lmbdLagrange, alpha, tIter, tIterCRRNN, tIterTV):
        return step_InfConv_Denoiser(model, x_noisy, lmbdLagrange, alpha,  tIter, tIterCRRNN, tIterTV)
