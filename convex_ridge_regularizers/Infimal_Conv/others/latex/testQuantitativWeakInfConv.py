...
# checkpoint_path = "C:/Users/waelg/OneDrive/Bureau/EPFL_5_2/Code/convex_ridge_regularizers/Infimal_Conv/InfimalConvolution/Training/Trained_models/InfConv_Sigma_5_t_1_2605/checkpoints/checkpoint_51860.pth"
# config = json.load(open(config_path))
# model, _ = utils.build_model(config)
# checkpoint = torch.load(checkpoint_path, map_location={'cuda:0':device,'cuda:1':device,'cuda:2':device,'cuda:3':device})
...
with torch.no_grad():
    for idx, im in enumerate(test_dataloader):
        ...
        im_init = im_noisy
        im_denoised,_,_,_ = SAGD_Recon(im_noisy, model, lmbd=10, mu=1, H=H, Ht=Ht, op_norm=1, x_gt=None, max_iter = 100, tol = 1e-3)
...
path = f"C:/Users/waelg/OneDrive/Bureau/EPFL_5_2/Code/convex_ridge_regularizers/Infimal_Conv/others/latex/Results_Quant_InfConv/Quantitativ_WCRRNN_lmbd_10_csv.csv"
