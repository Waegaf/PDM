...
config_path = "C:/Users/waelg/OneDrive/Bureau/EPFL_5_2/Code/convex_ridge_regularizers/Infimal_Conv/CRRNN/Training/Trained_models_Maryam/Sigma_5_Implicit_Layers_280524/config.json"
checkpoint_path = "C:/Users/waelg/OneDrive/Bureau/EPFL_5_2/Code/convex_ridge_regularizers/Infimal_Conv/CRRNN/Training/Trained_models_Maryam/Sigma_5_Implicit_Layers_280524/checkpoints/checkpoint_7200.pth"
...
# Load of the image (.png)
img = cv2.imread("C:/Users/waelg/OneDrive/Bureau/EPFL_5_2/Code/convex_ridge_regularizers/training/data/images/BSD/Set12/09.png", cv2.IMREAD_GRAYSCALE)
...
ax5.set_title(f"Denoised Image (Reg. Cost {model.cost(img_denoised)[0].item():.1f})")
ax5.imshow(img_denoised.detach().cpu().squeeze(), cmap="gray", vmin=0, vmax=1)
ax5.set_yticks([])
ax5.set_xticks([])

fileName = f"30040DenoisedLenna{lmbd:.0f}Implicit.png"
