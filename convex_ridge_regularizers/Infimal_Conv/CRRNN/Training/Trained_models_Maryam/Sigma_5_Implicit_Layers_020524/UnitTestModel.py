...
fileName = f"1405DenoisedLenna{lmbd:.0f}Sigma5ImplicitLayers.png"
path = os.path.join("Infimal_Conv/CRRNN/Training/Trained_models_Maryam/Sigma_5_Implicit_Layers_020524/Results", fileName)
plt.savefig(path)
